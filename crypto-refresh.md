...
- OpenPGP - This is a term for security software that uses PGP 5.x as a basis, formalized in {{RFC2440}} and this document.

- PGP - Pretty Good Privacy.
  PGP is a family of software systems developed by Philip R.
  Zimmermann from which OpenPGP is based.

- PGP 2.6.x - This version of PGP has many variants, hence the term PGP 2.6.x.
  It used only RSA, MD5, and IDEA for its cryptographic transforms.
  An informational RFC, {{RFC1991}}, was written describing this version of PGP.
...
- GnuPG - GNU Privacy Guard, also called GPG.
  ...
  GnuPG may or may not have (depending on version) support for IDEA or other encumbered algorithms.
...
Version 4 keys first appeared in PGP 5.0 and are the preferred key version for OpenPGP.
...
With PGP 5.x, this packet has been reassigned and is reserved for use as the Marker packet.
...
: Used for detached signatures, OpenPGP/MIME signatures, and cleartext signatures.
  Note that PGP 2.x uses BEGIN PGP MESSAGE for detached signatures.
...
- The IDEA algorithm is patented, and yet it is required for PGP 2.x interoperability.
